...
```
sudo wget -O /etc/apt/sources.list.d/dephataz.list https://dephataz.github.io/ubuntu22/dephataz.list  
```
```
sudo wget -O /etc/apt/trusted.gpg.d/dephataz-key.gpg https://dephataz.github.io/ubuntu22/KEY2.gpg  
```
```
sudo apt update  
```
